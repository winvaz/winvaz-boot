package com.icore.winvaz.javase.basic.designpattern.templatepattern;
 ...
 * 3、spring 中对 Hibernate的支持，将一些已经定好的方法封装起来，比如开启事务、获取 Session、关闭 Session 等，
...
/**
 * 创建一个抽象模板类，它的模板方法设置为final
 * @author wdq
 * @create 2021/4/1 15:22
 * @Return
 * @exception
 */
abstract class Game {
...
class Football extends Game {
    ...
    @Override
    void stop() {
        System.out.println("Football Game stop !");
    }
}