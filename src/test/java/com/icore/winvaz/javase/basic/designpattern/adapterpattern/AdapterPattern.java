package com.icore.winvaz.javase.basic.designpattern.adapterpattern;
 ...
 */
class VlcPlayer implements AvancedMediaPlayer {
...
class Mp4Player implements AvancedMediaPlayer {
...
class MediaAdapter implements MediaPlayer {
    ...
    AvancedMediaPlayer avancedMediaPlayer = null;

    public MediaAdapter(String audioType) {
        if (audioType.equalsIgnoreCase("vlc")) {
            avancedMediaPlayer = new VlcPlayer();
        } else if (audioType.equalsIgnoreCase("mp4")) {
            avancedMediaPlayer = new Mp4Player();
        }
    }
    ...
    public void play(String audioType, String fileName) {
        ...
        if (audioType.equalsIgnoreCase("vlc")) {
            avancedMediaPlayer.playVlc(fileName);
        } else if (audioType.equalsIgnoreCase("mp4")) {
            avancedMediaPlayer.playMp4(fileName);
        }
    }
}
